                    ...
                    <div className="py-8 md:py-8 md:px-6">
                        ...
                        <div className="space-y-4">
                            <p className="flex items-center">
                                ...
                                <span>A Block, Halishahar Chattogram, Bangladesh</span>
                            </p>
                            <p className="flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5 mr-2 sm:mr-6">
                                    <path d="M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.059-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z"></path>
                                </svg>
                                <span>+880 1633909408</span>
                            </p>
                            <p className="flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5 mr-2 sm:mr-6">
                                ...
                                <span>mohammadjahid0007@gmail.com</span>
                            </p>
                        </div>
                    </div>
                    <form
                        ...
                        <label className="block">
                            ...
                            <input type="email" placeholder="leroy@jenkins.com" className="py-2 pl-2 block w-full rounded-md shadow-sm focus:ring focus:ring-opacity-75 focus:ring-violet-400 bg-gray-100" />
                        </label>
                        <label className="block">
